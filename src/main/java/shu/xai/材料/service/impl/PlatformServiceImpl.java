...
public class PlatformServiceImpl implements PlatformService {
    ...
    public void SolveFeatureTable(String userId, String roleId,int split,int repeat,int iteration) {
        List<String> arg1 = Arrays.asList(String.valueOf(split));
        ...
        List<String> arg2 = Arrays.asList(String.valueOf(split), String.valueOf(repeat), String.valueOf(iteration));
